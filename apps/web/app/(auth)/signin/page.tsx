...
export default function SignInPage() {
  ...
  return (<AuthLayout title="Sign in to your account" subtitle="Enter your credentials to access your workflows" marketingTitle="Welcome back to Floe" marketingDescription={[
    "Pick up where you left off. Your workflows, integrations, and automations are waiting for you.",
    "Floe is a graph-based workflow engine with node-level retries, checkpointing, and crash-safe execution built for production systems.",
