...
const PLATFORMS = [
  ...
  { value: "mpesa", label: "M-Pesa", logo: "/logo/mpesa.svg", description: "Safaricom Daraja API — STK Push, B2C, status" },
...
function getKeyFields(platform: PlatformValue): CredentialField[] {
  switch (platform) {
    ...
    case "mpesa":
      return [
        { key: "consumerKey", label: "Consumer Key", placeholder: "Daraja App Consumer Key" },
        { key: "consumerSecret", label: "Consumer Secret", placeholder: "Daraja App Consumer Secret" },
        { key: "shortCode", label: "Shortcode (Paybill / Till)", placeholder: "174379", inputType: "text" as const },
        { key: "passkey", label: "Lipa na M-Pesa Passkey", placeholder: "bfb279f9aa9b..." },
        { key: "callbackUrl", label: "Callback URL", placeholder: "https://your-domain.com/api/mpesa/callback", inputType: "text" as const, helperText: "Publicly reachable URL for M-Pesa payment confirmations" },
        { key: "sandbox", label: "Sandbox Mode", placeholder: "true", inputType: "text" as const, helperText: "Set to true for Daraja sandbox, false for production", advanced: true },
      ];
    case "africastalking":
      return [
        { key: "apiKey", label: "API Key", placeholder: "atsk_..." },
        { key: "username", label: "Username", placeholder: "sandbox (for testing) or your AT username", inputType: "text" as const, helperText: "Use 'sandbox' for free testing on the Africa's Talking sandbox" },
      ];
    case "whatsapp":
      return [
        { key: "accessToken", label: "Access Token", placeholder: "EAAxxxxx..." },
        { key: "phoneNumberId", label: "Phone Number ID", placeholder: "12345678901234", inputType: "text" as const, helperText: "Found in Meta for Developers → WhatsApp → API Setup" },
      ];
    case "kraETR":
      return [
        { key: "apiKey", label: "ETR Middleware API Key", placeholder: "API key from your ETR provider" },
