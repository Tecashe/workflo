...
export const metadata: Metadata = {
  ...
  description: "Floe Privacy Policy",
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
      ...
      <div className="space-y-10 text-white/70 text-[15px] leading-relaxed">
        <section>
          ...
          <p>
            Welcome to Floe. We respect your privacy and are committed to
        ...
        <section>
          ...
          <p>
            ...
            contact us at{" "}
            <a href="mailto:privacy@floe.com" className="text-[#F04D26] hover:underline">
              privacy@floe.com
            </a>
            .
          </p>
