...
export const metadata: Metadata = {
  ...
  description: "Floe Terms of Service",
};
    ...
    <div className="mx-auto max-w-3xl px-6 py-16 md:py-24">
      ...
      <div className="space-y-10 text-white/70 text-[15px] leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using Floe&apos;s workflow automation platform
        ...
        <section>
          ...
          <p>
            Floe provides a visual workflow automation platform that allows
        ...
        <section>
          ...
          <p>
            ...
            by Floe and protected by intellectual property laws. You retain
        ...
        <section>
          ...
          <p>
            ...
            third party&apos;s terms and policies. Floe is not responsible
        ...
        <section>
          ...
          <p>
            ...
            necessary for your workflows. Floe is not liable for any
        ...
        <section>
          ...
          <p>
            To the maximum extent permitted by law, Floe shall not be
        ...
        <section>
          ...
          <p>
            ...
            <a href="mailto:legal@floe.com" className="text-[#F04D26] hover:underline">
              legal@floe.com
            </a>
            .
          </p>
