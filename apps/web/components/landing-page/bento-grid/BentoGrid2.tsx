...
import { F5Security } from "./F5Security";
import { F6Pipeline } from "./F6Pipeline";
...
export function BentoGrid2() {
    return (
        <div className="relative z-10 w-full max-w-[1200px] xl:max-w-[1240px] mx-auto px-2 sm:px-3 md:px-4 lg:px-0">
            <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5 lg:gap-3 xl:gap-4">
