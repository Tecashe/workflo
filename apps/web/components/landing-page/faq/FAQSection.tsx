...
const faqData: FAQItem[] = [
  {
    ...
    answer: "Floe is a workflow automation platform where you build flows visually, connect integrations, and run AI + API automations from one place."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. Floe supports integrations like HTTP APIs, webhooks, Notion, Slack, Discord, GitHub, and AI providers such as OpenAI, Anthropic, and Gemini."
  },
  {
    question: "Do I need coding experience to use Floe?",
